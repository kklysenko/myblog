...
if ( ! function_exists( 'myblog_setup' ) ) :
	...
	function myblog_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'myblog' ),
			)
		);
...
function myblog_scripts() {
	...
	wp_enqueue_script( 'myblog-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'myblog-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), _S_VERSION, true );
